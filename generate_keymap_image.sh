...
keymap -c keymap_image/keymap_draw_config.yaml parse -c 12 -z config/corne.keymap > keymap_image/corne_keymap.yaml
keymap -c keymap_image/keymap_draw_config.yaml draw keymap_image/corne_keymap.yaml > keymap_image/corne_keymap.svg
